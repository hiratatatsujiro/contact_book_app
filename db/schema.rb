...
ActiveRecord::Schema.define(version: 2021_08_15_122725) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "pay_for_shopping_id", null: false
    t.integer "delivery_area_id", null: false
  ...
  create_table "likes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["class_communication_id"], name: "index_likes_on_class_communication_id"
  ...
  add_foreign_key "likes", "class_communications"
